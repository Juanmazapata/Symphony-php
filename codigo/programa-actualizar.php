...
$logotipo_cargar=htmlentities(addslashes($_POST['lblogotipo']));

$cod_programa=htmlentities(addslashes($_POST['txtcodprograma']));
...
$logotipo='programa_' . $cod_programa . '.png';

$tipo_logotipo=$_FILES['fllogotipo']['type'];

$tamagno_logotipo=$_FILES['fllogotipo']['size'];

if ($tipo_logotipo==null && $logotipo_cargar=='logotipo-programa.png') {
$logotipo='logotipo-programa.png';

}elseif($tipo_logotipo==null && $logotipo!='logotipo-programa.png'){
...
$actualizar_programa_sql="UPDATE programa SET nom_programa=:pro,
	descripcion=:des,
	niveles=:niv,
	dias_realizo=:rea,
	h_inicio_M=:ini_m,
	h_finalizacion_M=:fin_m,
	h_inicio_T=:ini_t,
	h_finalizacion_T=:fin_t,
	h_inicio_N=:ini_n,
	h_finalizacion_N=:fin_n,
	director=:dir,
	monitor1=:mon1,
	cargo1=:carg1,
	monitor2=:mon2,
	...
	repertorio=:rep,
	logotipo=:logi,
usuario_actualizo=:usua,
f_actualizacion=:act WHERE id=:id";

$resultado=$conexion->prepare($actualizar_programa_sql);
...
echo "El Programa se ha actualizado satisfactoriamente.";
